...
use App\Http\Resources\Admin\Schedule\GetFullTimeResource;
use App\Models\Division;
use App\Models\DivisionTypeSchedule;
use App\Models\Time;
...
class FullTimeController extends Controller
{
    ...
    public function index()
    {
        ...
        return GetFullTimeResource::collection($time);
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            $user = Auth::user();
            $fulltime = WorkTime::where('name', '=', 'Full Time')->first();
            ...
            $user->log()->create([
                'log' => 'Add division to full time at ' . now()
            ]);
            DB::commit();
            ...
            DB::rollBack();
            Log::error([
                'title' => 'Add division to full time',
                'file' => 'Controller : api/SuperAdmin/Schedule/FullTimeController.php',
                'pesan' => $e->getMessage(),
                'baris' => $e->getLine()
            ]);
