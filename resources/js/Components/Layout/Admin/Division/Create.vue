            ...
            <form action="" @submit.prevent="create" class="font-second text-black my-2">
                <div class="grid grid-cols-2 gap-5 max-h-96 overflow-y-scroll scroll-smooth px-3">
                    <div data-aos="fade-left" data-aos-delay="500" data-aos-offset="0" class="grid grid-cols-1 gap-2">
                        <label for="" class="text-lg text-white italic">Name</label>
                        <input type="text" name="" id="" v-model="form.name" class="px-4 py-2 rounded-lg border border-cyan-400 bg-white/50 backdrop-blur-sm text-black outline-none transition-all duration-300 focus:border-cyan-400 focus:shadow-[0_0_5px_#22d3ee,0_0_10px_#22d3ee,0_0_20px_#22d3ee]">
                    ...
                    <div data-aos="fade-down" data-aos-delay="500" data-aos-offset="0" class="col-span-2 grid grid-cols-1 gap-2">
                        <label for="" class="text-lg text-white italic">Description</label>
                        <textarea name="" id="" v-model="form.division" class="px-4 py-2 rounded-lg border max-h-20 border-cyan-400 bg-white/50 backdrop-blur-sm text-black outline-none transition-all duration-300 focus:border-cyan-400 focus:shadow-[0_0_5px_#22d3ee,0_0_10px_#22d3ee,0_0_20px_#22d3ee]"></textarea>
                        <p class="text-xs font-second text-red-800">Error</p>
                    </div>
                </div>
